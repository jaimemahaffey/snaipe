...
- [x] **Step 2: Run tests — expect compile failure (types don't exist yet)**
...
- [x] **Step 3: Add new message types and change TreeResponse in Messages.cs**
...
- [x] **Step 4: Register new types in ProtocolJsonContext.cs**
...
- [x] **Step 1: Add `eventsPipeName` to AgentDiscovery.Create**
...
- [x] **Step 2: Add `EventsPipeName` to `AgentInfo` and read it in the scanner**
...
- [x] **Step 3: Build Protocol and Inspector projects to verify**
...
- [x] **Step 1: Tag the overlay canvas**
...
- [x] **Step 2: Build Agent project to verify (expect existing Task 1 errors only, no new ones)**
...
- [x] **Step 2: Run test — expect compile failure (AgentEventServer not found)**
...
- [x] **Step 3: Implement AgentEventServer**
...
- [x] **Step 1: Create PickModeManager**
...
- [x] **Step 2: Build the Agent to verify — expect only the existing TreeResponse.Root error from Task 1**
...
- [x] **Step 1: Add popup-aware BuildTree overload**
...
- [x] **Step 2: Build Agent — expect same single error as before (SnaipeAgent.Root reference)**
...
- [x] **Step 1: Replace SnaipeAgent.cs**
...
- [x] **Step 2: Build Agent — expect zero errors**
...
- [x] **Step 3: Run all Agent tests — expect pass**
...
- [x] **Step 2: Run test — expect compile failure (ConnectEventsAsync not found)**
...
- [x] **Step 3: Implement events pipe in InspectorIpcClient.cs**
...
- [x] **Step 4: Create AssemblyInfo.cs for InternalsVisibleTo (needed by Task 9 tests)**
...
- [x] **Step 5: Run events pipe tests — expect pass**
...
- [x] **Step 6: Run full Inspector test suite — expect all pass**
...
- [x] **Step 2: Run tests — expect compile failure (OnAgentEventReceived not accessible)**
...
- [x] **Step 3: Update MainViewModel.cs**
...
- [x] **Step 4: Run new pick tests — expect pass**
...
- [x] **Step 5: Run full Inspector test suite — expect all pass**
